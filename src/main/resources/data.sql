...
INSERT INTO GUEST (LAST_NAME, FIRST_NAME, EMAIL_ADDRESS, COUNTRY, ADDRESS, STATE, PHONE_NUMBER) VALUES('Popescu', 'Lidia', 'lidia2popescu@gmail.com', 'Romania', 'Traian Street', 'GL', '0040742998911');
...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Popescu'), '2022-01-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'M1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Fields' ), '2022-01-01');
